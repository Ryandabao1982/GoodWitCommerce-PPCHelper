            ...
            {brands.length > 0 && (
              <div className="flex items-center gap-2">
                <select
                  ...
                  className="px-2 sm:px-3 py-2 bg-gray-100 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 dark:text-white max-w-[120px] sm:max-w-none"
                  title="Select brand"
                >
                  {brands.map((brand) => (
