...
export const AssignmentDrawer: React.FC<AssignmentDrawerProps> = ({
  ...
  const handleAssign = () => {
    ...
    if (onAssign) {
      onAssign(selectedCampaign, rec?.suggestedAdGroup, rec?.suggestedMatchType, bid);
    }
        ...
        <div className="p-6">
          ...
          <div className="flex items-start justify-between mb-6">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400">{keywordName}</p>
            </div>
            <button
              onClick={onClose}
          ...
          {recommendations.length === 0 ? (
            <div className="text-center py-12">
              ...
              <div className="text-gray-600 dark:text-gray-400">No recommendations available</div>
                  ...
                  <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                    <div className="mb-4">
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                        Leave empty to use suggested bid: $
                        {selectedRec.suggestedBid?.toFixed(2) || '0.50'}
                      </p>
                    </div>
                  </div>
                </div>
